...
const HeroPage = () => {
  ...
  return (
    <div className="overflow-x-hidden auto-hide-scrollbar">
      {isPopupVisible && (
      ...
      >
        ...
        >
          <source
            src="https://firebasestorage.googleapis.com/v0/b/website-kelas-bf7e0.appspot.com/o/video%2Fbg.mp4?alt=media&token=ac3b19f7-f84c-49ff-adb3-7a53268d3f8a"
            type="video/mp4"
          />
        </video>
